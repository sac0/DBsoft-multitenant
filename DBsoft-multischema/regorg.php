...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
  	...
  	<title>DBsoft | New User Registration</title>
...
<div class="row">
    <div class="col-sm-6 col-sm-offset-3">
      <h3 class="text-info text-center" style="padding-bottom:15px; border-bottom: 1px solid #aaa;">Sign Up DBsoft <br><small class="text-left">Please Enter the information given below.</small> </h3>
      <div id="infoMessage"></div>  
      <form method="post" action="register.php" name="registerform">
        <div class="form-group">
          <div class="col-sm-6">
            <label class="control-label" for="org_name"> Org Name</label>
            <input type="text" class="form-control" name="org_name" placeholder="Org Name" />
          </div>
          <div class="col-sm-6">
            <label class="control-label" for="name"> Name</label>
            <input type="text" class="form-control" name="user_fname" placeholder="Name" />
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-6">
